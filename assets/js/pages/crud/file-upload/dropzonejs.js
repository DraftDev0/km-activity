    ...
    var demo1 = function() {
        ...
        $("#kt_dropzone_2").dropzone({
            ...
            removedfile: function(file) {
                ...
                $.ajax({
                    type: "POST",
                    url: "removeuploadDoc.php",
                    data: "id=" + ($("#DocID").val() + name),
                    dataType: "html",
                });
                var _ref;
            ...
            init: function() {
                this.on("sending", function(file, xhr, formData) {
                    formData.append("formid", $("#DocID").val());
        ...
        $("#kt_dropzone_3").dropzone({
            ...
            removedfile: function(file) {
                var name = file.name;
                console.log($("#ActivityID").val() + name);
                $.ajax({
                    type: "POST",
                    url: "removeuploadActivity.php",
                    data: "id=" + ($("#ActivityID").val() + name),
                    dataType: "html",
                });
                var _ref;
                return (_ref = file.previewElement) != null ?
            ...
            init: function() {
                this.on("sending", function(file, xhr, formData) {
                    formData.append("formid", $("#ActivityID").val());
                    console.log(formData);
                });
            },
        });

        // console.log($("#uniqodformDocument").val());
        // console.log($("#uniqidformActivity").val());
    };
